...
generator = cms.EDFilter("PyquenGeneratorFilter",
    ...
    decays      = cms.int32(211), # does not cut on daughters of D0, but needed by the filter, so require there is a pion in the daughters
    ...
    filterType = cms.untracked.string("PartonHadronDecayGenEvtSelector"), #just filter on parton and D0 as we are using evetgen to force the decay
