...
generator = cms.EDFilter("PyquenGeneratorFilter",
    ...
    decays      = cms.int32(211), # does not cut on daughters of Ds, but needed by the filter, so require there is a pion in the daughters
    ...
    filterType = cms.untracked.string("PartonHadronDecayGenEvtSelector"), #just filter on parton and Ds as we are using evetgen to force the decay
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Ds_phipi_KK.dec'),
